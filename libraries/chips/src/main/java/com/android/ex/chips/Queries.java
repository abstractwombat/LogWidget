...
/* package */ class Queries {
    ...
    public static final Query NAME = new Query(new String[] {
            Contacts.DISPLAY_NAME,                          // 0
            Contacts.DISPLAY_NAME,                          // 1
            Contacts.DISPLAY_NAME,                          // 2
            Contacts.DISPLAY_NAME,                          // 3
            Contacts.NAME_RAW_CONTACT_ID,                   // 4
            Contacts._ID,                                   // 5
            Contacts.PHOTO_THUMBNAIL_URI,                   // 6
            Contacts.DISPLAY_NAME_SOURCE,                   // 7
            Contacts.LOOKUP_KEY,                            // 8
            Contacts.DISPLAY_NAME // 9
    }, Contacts.CONTENT_FILTER_URI, ContactsContract.Contacts.CONTENT_URI) {
