...
public class Security {
    ...
    public static boolean verifyPurchaseRemote(String verificationUrl, String signedData, String signature, String packageName) {
        ...
        NameValuePair packageNamePair = new BasicNameValuePair("package", packageName);

        HttpForJson httpForJson = new HttpForJson(verificationUrl);
        JSONObject json = httpForJson.preform(dataPair, signaturePair, packageNamePair);
