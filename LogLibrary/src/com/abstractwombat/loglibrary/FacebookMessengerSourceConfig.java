...
public class FacebookMessengerSourceConfig extends LogSourceConfig {
	...
	public static int DEFAULT_BUBBLE_RESOURCE = R.drawable.msg_bubble_facebook;
	public static int DEFAULT_BUBBLE_COLOR = Color.WHITE;

	public FacebookMessengerSourceConfig(){
		super();
		this.showImage = true;
		this.showName = true;
	...
	public FacebookMessengerSourceConfig(LogSourceConfig config){
	...
	public FacebookMessengerSourceConfig(String sourceID, int groupID, Context context){
    ...
    public void setToDefaults(Context context){
        ...
        this.showImage = res.getBoolean(R.bool.facebookmessenger_source_default_showimage);
        this.showName = res.getBoolean(R.bool.facebookmessenger_source_default_showname);
        this.longDataFormat = res.getBoolean(R.bool.facebookmessenger_source_default_longdate);
		this.maxLines = res.getInteger(R.integer.facebookmessenger_source_default_maxlines);
		this.rowColor = res.getColor(R.color.facebookmessenger_source_default_rowcolor);
		this.textColor = res.getColor(R.color.facebookmessenger_source_default_textcolor);
		this.bubbleResource = DEFAULT_BUBBLE_RESOURCE;
		this.bubbleColor = DEFAULT_BUBBLE_COLOR;
		this.bubbleResourceName = "";
		this.textSize = DEFAULT_TEXT_SIZE;
		this.showEmblem = res.getBoolean(R.bool.facebookmessenger_source_default_showemblem);
	}
