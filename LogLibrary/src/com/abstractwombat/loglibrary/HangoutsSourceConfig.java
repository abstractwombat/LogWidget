...
public class HangoutsSourceConfig extends LogSourceConfig {
	...
	public static int DEFAULT_BUBBLE_RESOURCE = R.drawable.msg_bubble_incoming;
	...
	public HangoutsSourceConfig(LogSourceConfig config){
	...
	public HangoutsSourceConfig(String sourceID, int groupID, Context context){
    ...
    public void setToDefaults(Context context){
        ...
        this.showImage = res.getBoolean(R.bool.hangouts_source_default_showimage);
        this.showName = res.getBoolean(R.bool.hangouts_source_default_showname);
        this.showSMS = res.getBoolean(R.bool.hangouts_source_default_showsms);
        this.longDataFormat = res.getBoolean(R.bool.hangouts_source_default_longdate);
		this.maxLines = res.getInteger(R.integer.hangouts_source_default_maxlines);
		this.rowColor = res.getColor(R.color.hangouts_source_default_rowcolor);
		this.textColor = res.getColor(R.color.hangouts_source_default_textcolor);
		this.bubbleResource = DEFAULT_BUBBLE_RESOURCE;
		this.bubbleColor = DEFAULT_BUBBLE_COLOR;
		this.bubbleResourceName = "";
		this.textSize = DEFAULT_TEXT_SIZE;
		this.showEmblem = res.getBoolean(R.bool.hangouts_source_default_showemblem);
	}
	...
	public int unserialize(String s){
		...
		if (a[i++].equals("1")) this.showSMS = true;
		else this.showSMS = false;
