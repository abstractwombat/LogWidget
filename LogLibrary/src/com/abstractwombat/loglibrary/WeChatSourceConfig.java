...
public class WeChatSourceConfig extends LogSourceConfig {
	...
	public WeChatSourceConfig(LogSourceConfig config){
	...
	public WeChatSourceConfig(String sourceID, int groupID, Context context){
    ...
    public void setToDefaults(Context context){
        ...
        this.showImage = res.getBoolean(R.bool.wechat_source_default_showimage);
        this.showName = res.getBoolean(R.bool.wechat_source_default_showname);
        this.longDataFormat = res.getBoolean(R.bool.wechat_source_default_longdate);
		this.maxLines = res.getInteger(R.integer.wechat_source_default_maxlines);
		this.rowColor = res.getColor(R.color.wechat_source_default_rowcolor);
		this.textColor = res.getColor(R.color.wechat_source_default_textcolor);
		this.bubbleResource = DEFAULT_BUBBLE_RESOURCE;
		this.bubbleColor = DEFAULT_BUBBLE_COLOR;
		this.bubbleResourceName = "";
		this.textSize = DEFAULT_TEXT_SIZE;
		this.showEmblem = res.getBoolean(R.bool.wechat_source_default_showemblem);
	}
