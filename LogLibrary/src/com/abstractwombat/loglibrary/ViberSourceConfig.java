...
public class ViberSourceConfig extends LogSourceConfig {
	...
	public static int DEFAULT_BUBBLE_RESOURCE = R.drawable.bg_msg_incoming;
	...
	public ViberSourceConfig(LogSourceConfig config){
	...
	public ViberSourceConfig(String sourceID, int groupID, Context context){
    ...
    public void setToDefaults(Context context){
        ...
        this.showImage = res.getBoolean(R.bool.viber_source_default_showimage);
        this.showName = res.getBoolean(R.bool.viber_source_default_showname);
        this.longDataFormat = res.getBoolean(R.bool.viber_source_default_longdate);
		this.maxLines = res.getInteger(R.integer.viber_source_default_maxlines);
		this.rowColor = res.getColor(R.color.viber_source_default_rowcolor);
		this.textColor = res.getColor(R.color.viber_source_default_textcolor);
		this.bubbleResource = DEFAULT_BUBBLE_RESOURCE;
		this.bubbleColor = DEFAULT_BUBBLE_COLOR;
		this.bubbleResourceName = "";
		this.textSize = DEFAULT_TEXT_SIZE;
		this.showEmblem = res.getBoolean(R.bool.viber_source_default_showemblem);
	}
